...
var NavLink = React5.forwardRef((_a, ref) => {
  var _b = _a, {
    bsPrefix,
    className,
  ...
  return (0, import_jsx_runtime4.jsx)(Component, __spreadProps(__spreadValues(__spreadValues({}, props), navItemProps), {
    ref,
...
function useForceUpdate() {
  var _useReducer = (0, import_react11.useReducer)(function(state) {
    return !state;
...
var TabContext = React6.createContext(null);
...
var Nav2 = React9.forwardRef((uncontrolledProps, ref) => {
  ...
  return (0, import_jsx_runtime6.jsx)(Nav_default, __spreadValues({
    as,
    ref,
    activeKey,
...
//# sourceMappingURL=chunk-MP462BAL.js.map
